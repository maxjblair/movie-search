                ...
                <div key={movie.id} className="movie-tile">
                    <div className="movie-tile-container">
                        ...
                        <div className="movie-tile-details">
                            ...
                            <p className="font-small"><label>Rating:</label> {movie.vote_average === 0 ? 'No Rating' : movie.vote_average}</p>
                            <p className="font-small"><label>Description</label><br />{movie.overview}</p>
